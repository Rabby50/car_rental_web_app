...
{{-- ----------index user rental form on setart ---------------------------------------------------------------------------------------- --}}
                                            <h4 class="text-white mb-4">CONTINUE CAR RESERVATION</h4>
                                            <iframe style="width:550px; height: 450px;" src="{{route('sroll_table')}}" frameborder="0"></iframe>
{{-- ----------index user rental form on end ------------------------------------------------ --}}
        ...
        <div class="container-fluid categories pb-5">
            <div class="container pb-5">
                ...
                <div id="car_categories" class="categories-carousel owl-carousel wow fadeInUp" data-wow-delay="0.1s">
                    @foreach ($cars as $car)
                    <div class="categories-item p-4">
                        <div class="categories-item-inner">
                            ...
                            <div class="categories-content rounded-bottom p-4">
                                ...
                                <div class="mb-4">
                                    <h4 class="bg-white text-primary rounded-pill py-2 px-4 mb-0">{{ $car->daily_rent_price }}</h4>
                                </div>
                                <div class="row gy-2 gx-0 text-center mb-4">
                                    ...
                                    @if($car->availability === 0)
                                        <div class="col-4"><span class="badge bg-danger">SoldOut</span></div>
                                    @else
                                        <div class="col-4"><span class="badge bg-success">Avilable</span></div>
                                    @endif
                                    
                                </div>
                                <a href="{{route('user.rental',['id'=>$car->id])}}" class="btn btn-primary rounded-pill d-flex justify-content-center py-3">Book Now</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
